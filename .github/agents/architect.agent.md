...
instructions: |
  Clarify requirements and success criteria, outline a high-level approach with key components, data flows, and risks, identify impacted areas and describe the smallest viable change set, and provide acceptance criteria with a handoff to the developer agent.
examples:
