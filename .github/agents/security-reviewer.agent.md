...
instructions: |
  ...
  and dependency risks. Run npm audit to surface dependency concerns. Confirm
  sensitive data handling stays client-side and document any unresolved
  concerns with mitigation guidance.
examples:
